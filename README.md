...
```
## Contributions
In order to push updates to the master branch, a pull request and an approving review from another contributor are required. This avoids conflicts and helps everyone be on the same page.
...
```
### Open a pull request
  1.  Go to the [repository](https://github.com/dseeler/CSCI4050-Bookstore) on the GitHub website
